...
const servicesData = [
    ...
    },
    {
        ...
        description: 'Oferecemos cuidados dedicados para crianças de 6 meses a 7 anos, focando no desenvolvimento motor e bem-estar. Nossa abordagem utiliza o ambiente lúdico para garantir que o tratamento seja eficaz e prazeroso para os pequenos.',
        items: [
            'Público-alvo: Crianças de 6 meses até 7 anos',
            'De 6 meses a 3 anos: Atividades na piscina acompanhadas obrigatoriamente pelos pais',
            'Acima de 3 anos: A criança realiza o atendimento individualmente com o profissional',
            'Estímulo ao desenvolvimento neuropsicomotor e coordenação',
        ],
        ctaText: 'Agendar Sessão',
        whatsappLink: 'https://api.whatsapp.com/send?phone=5516994593131&text=Ol%C3%A1%2C%20gostaria%20de%20saber%20mais%20sobre%20o%20atendimento%20Infantil%20(6%20meses%20a%207%20anos).',
        image: '/images/vetor infantil.svg', //NECESSÁRIO ADIÇÃO DA IMAGEM VETOR INFANTIL
        aosContent: 'fade-right',
        aosImage: 'fade-left',
    },
    {
            ...
            <nav id="servicesNavbar" className="services-nav-menu sticky-top">
                <div className="container">
                    <ul className="nav nav-pills justify-content-center flex-nowrap">
                        ...
                        <li className="nav-item"><a className="nav-link" href="#infantil">Infantil</a></li>
